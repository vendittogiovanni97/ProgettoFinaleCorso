...
const ThemeProviderInner: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const dynamicStyles = {
    ':root': {
      '--primary-color': mode === 'dark' ? 'var(--primary-color-dark)' : 'var(--primary-color-light)',
      '--background-dark': mode === 'dark' ? 'var(--background-dark-dark)' : 'var(--background-dark-light)',
      '--background-light': mode === 'dark' ? 'var(--background-light-dark)' : 'var(--background-light-light)',
      '--text-light': mode === 'dark' ? 'var(--text-light-dark)' : 'var(--text-light-light)',
      '--text-dark': mode === 'dark' ? 'var(--text-dark-dark)' : 'var(--text-dark-light)',
      '--border-color': mode === 'dark' ? 'var(--border-color-dark)' : 'var(--border-color-light)',
      '--hover-color': mode === 'dark' ? 'var(--hover-color-dark)' : 'var(--hover-color-light)',
    },
    '@import': 'tailwindcss',
  };
