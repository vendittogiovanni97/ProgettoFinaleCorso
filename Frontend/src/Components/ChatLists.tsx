...
import { ChatListsProps } from "../types/typesChatLists";

const ChatLists: React.FC<ChatListsProps> = ({ contacts, groups, onSelectChat, activeChatId }) => {
    ...
    return (
      <div className="chat-lists">
        ...
        <div className="chat-list">
          {activeTab === 'people' && filteredContacts.map(contact => (
            <div 
              key={contact.id}
            ...
            >
              ...
              <div className="chat-details">
                <div className="chat-name">
                  {contact.name}
                  {contact.isOnline && <span className="status-indicator"></span>}
                </div>
